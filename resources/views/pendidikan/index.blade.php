...
<div class="card card-info">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select name="jenis_sekolah" class="form-control  @error('jenis_sekolah') is-invalid @enderror">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control  @error('nilai_satu') is-invalid @enderror"
                    id="namasekolah" name="nilai_satu" placeholder="Masukkan Nilai"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control  @error('nilai_dua') is-invalid @enderror"
                    id="namasekolah" name="nilai_dua" placeholder="Masukkan Nilai"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control  @error('nilai_tiga') is-invalid @enderror"
                    id="namasekolah" name="nilai_tiga" placeholder="Masukkan Nilai"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control  @error('nilai_empat') is-invalid @enderror"
                    id="namasekolah" name="nilai_empat" placeholder="Masukkan Nilai"
...
@endif
<button type="submit" class="btn btn-primary btn-md float-right mt-2">Simpan dan Lanjutkan</button>
</form>
@endsection