                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">LOGIN SIPEMA</h1>
                                    </div>
                                    <form class="user" role="form" method="POST" action="{{ url('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input name="kunci_akun_siswa" type="password"
                                                class="form-control form-control-user @error('kunci_akun_siswa') is-invalid @enderror"
